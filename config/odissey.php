...
return [
    ...
    */
    ...
    'direct_stream_stall_seconds' => (int) env('ODISSEY_DIRECT_STREAM_STALL_SECONDS', 30),
    ...
    */
    ...
    'remote_probe_max_bytes' => (int) env('ODISSEY_REMOTE_PROBE_MAX_BYTES', 16 * 1024 * 1024),
    'remote_probe_max_items_per_scan' => (int) env('ODISSEY_REMOTE_PROBE_MAX_ITEMS_PER_SCAN', 250),
    'remote_probe_retry_days' => (int) env('ODISSEY_REMOTE_PROBE_RETRY_DAYS', 30),
    'remote_materialize_max_source_bytes' => (int) env('ODISSEY_REMOTE_MATERIALIZE_MAX_SOURCE_BYTES', 3 * 1024 * 1024 * 1024),
    'remote_transcode_max_source_bytes' => (int) env('ODISSEY_REMOTE_TRANSCODE_MAX_SOURCE_BYTES', 32 * 1024 * 1024 * 1024),
